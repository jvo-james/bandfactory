const BF_CATALOG_DEFAULTS = [
  ...
  ...[
    ...
    ['Chartreuse','ribbed-olive'],['Green','ribbed-teal'],['Orange','ribbed-orange'],['Burgundy','ribbed-burgundy'],['Caramel','ribbed-mustard'],['Flamingo','ribbed-flamingo']
  ].map(([color,id],i)=>({id,category:'ribbed',name:`${color} Ribbed Hairband`,subtitle:color,price:null,color,description:`Classic ribbed hairband in ${color}.`,stock:25,available:true,imageKey:id,featuredOrder:10+i})),
