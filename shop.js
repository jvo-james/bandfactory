...
function compareAtPrice(){const old=Number(activeStyle==='twisted'?(settings.twistedRetailCompareAtPrice??0):(settings.retailCompareAtPrice??0));return old>price()?old:0}
function shopPriceHtml(){return BFCatalog.priceHtml(price(),compareAtPrice(),'shop-sale-price')}
