...
/* -------------------------
   PAGE
   Native A5 packing slip (148 x 210 mm).
   Long orders may continue onto another A5 page so text stays readable.
------------------------- */
...
<script>
window.onload=()=>{
  // Print the native A5 layout at full size; do not shrink the receipt.
